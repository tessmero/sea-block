...
export const CAMERA: Vector3 = new Vector3(
  CAM_SCALE, CAM_SCALE, CAM_SCALE)

export const PORTRAIT_CAM_SCALE = 45
export const PORTRAIT_CAMERA: Vector3 = new Vector3(
  PORTRAIT_CAM_SCALE, PORTRAIT_CAM_SCALE, PORTRAIT_CAM_SCALE)
