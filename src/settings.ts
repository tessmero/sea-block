...
const camScale = 25
export const CAMERA: Vector = { x: camScale, y: camScale, z: camScale }
export const CAMERA_LOOK_AT: Vector = { x: 0, y: 10, z: 0 }
...
export const GRAVITY: Vector = { x: 0, y: -1e-3, z: 0 }
...
export const WATER_FRICTION = 1e-3
export const WATER_SPRING = 1e-4 // spring towards neighbor tile level
export const WATER_CENTERING = 1e-5 // spring towards sea level
export const WATER_DAMPING = 3e-4

// hacky sphere-water interaction
export const WAVE_AMPLITUDE = 10 // how far water tile moves
export const BUOYANT_FORCE = 4e-4 // tile pushes sphere up
